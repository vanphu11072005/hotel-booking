...
const RoomCardSkeleton: React.FC = () => {
  return (
    <div 
      className="bg-white dark:bg-gray-800/80 rounded-lg shadow-md 
    ...
    >
      ...
      <div className="p-5">
        ...
        >
          <div>
            <div className="h-3 bg-gray-200 dark:bg-gray-600 rounded w-12 mb-1" />
              <div className="h-7 bg-gray-300 dark:bg-gray-600 rounded w-24 mb-1" />
              <div className="h-3 bg-gray-200 dark:bg-gray-600 rounded w-10" />
          </div>
